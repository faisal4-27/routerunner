...
The route generator only needs one helper — `fetch_osrm_route_through_points`
— because a closed loop is built as a single multi-coordinate request rather
than five stitched legs.
"""
